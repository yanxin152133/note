...
## 1.8. Azkaban
- [Azkaban3.x 编译及部署](notes/大数据/大数据常用软件安装/Azkaban/Azkaban3.x编译及部署.md)
      
## 1.9. Hive
- [基于Zookeeper搭建Hive高可用环境](notes/大数据/大数据常用软件安装/Hive/基于Zookeeper搭建Hive高可用环境.md)
        
## 1.10. Zookeeper
- [Zookeeper集群环境搭建](notes/大数据/大数据常用软件安装/zookeeper/Zookeeper集群环境搭建.md)
         
## 1.11. Kafka
- [基于 Zookeeper 搭建 Kafka 高可用集群](notes/大数据/大数据常用软件安装/Kafka/基于Zookeeper搭建Kafka高可用集群.md)
